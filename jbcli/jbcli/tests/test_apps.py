...
class TestApps:
    ...
    def test_perform_init_vcs(self, check_mock, cd_mock, link_mock, url_mock):
        ...
        assert check_mock.mock_calls == [
            ...
            call(["git", "remote", "add", "origin", "git@github.com:cookies/sugar"]),
    ...
    @patch("jbcli.utils.apps.os.chdir")
    @patch("jbcli.utils.apps.check_call")
    def test_perform_init_vcs_no_track(self, check_mock, cd_mock, link_mock, url_mock):
        url_mock.return_value = "git@github.com:cookies/sugar"
        link_mock.return_value = "https://github.com/cookies/sugar"
    ...
    def test_perform_init_vcs_git_fail(
        self, echo_mock, check_mock, cd_mock, link_mock, url_mock
    ):
        url_mock.return_value = "git@github.com:cookies/sugar"
        link_mock.return_value = "https://github.com/cookies/sugar"
        ...
        assert link_mock.mock_calls == [call("sugar")]
        assert url_mock.mock_calls == [call("sugar")]
        assert echo_mock.mock_calls == [call("Failed to initialize Git repository.")]
    ...
    @patch("jbcli.utils.apps.check_call")
    @patch("jbcli.utils.apps.echo_warning")
    def test_perform_init_vcs_push_fail(
        self, echo_mock, check_mock, cd_mock, link_mock, url_mock
    ):
        url_mock.return_value = "git@github.com:cookies/sugar"
        link_mock.return_value = "https://github.com/cookies/sugar"
    ...
    @patch("jbcli.utils.apps.check_call")
    @patch("jbcli.utils.apps.echo_warning")
    def test_perform_init_vcs_desktop_fail(
        self, echo_mock, check_mock, cd_mock, link_mock, url_mock
    ):
        url_mock.return_value = "git@github.com:cookies/sugar"
        link_mock.return_value = "https://github.com/cookies/sugar"
    ...
    def test_clone(self, vcs_mock, ry_mock, os_mock, sh_mock):
        ...
        assert vcs_mock.mock_calls == [call("cookies", "apps/cookies", True)]
        assert ry_mock.mock_calls == [
            call("apps/cookies/app.yaml", replacements),
        ]
        assert os_mock.mock_calls == [call.path.join("apps/cookies", "app.yaml")]
    ...
    def test_clone_no_track(self, vcs_mock, ry_mock, os_mock, sh_mock):
        ...
        assert vcs_mock.mock_calls == [call("cookies", "apps/cookies", False)]
        assert ry_mock.mock_calls == [
            call("apps/cookies/app.yaml", replacements),
        ]
        assert os_mock.mock_calls == [
    ...
    def test_replace_in_yaml(self, open_mock, os_mock, sh_mock, temp_mock):
        replacements = {"slug:": "cookies", "label:": "cookies", "id:": "aedc2134"}
        ...
        assert open_mock.mock_calls == [call(2, "w"), call("/tmp/cookies.yaml")]
        assert os_mock.mock_calls == [call.close(1), call.remove("/tmp/cookies.yaml")]
