...
class TestDocker:
    ...
    def test_multiple_docker_compose_files(self, glob_mock, check_mock):
        ...
        glob_mock.return_value = [
            "docker-compose-coolio.yml",
            "docker-compose-2pac.yml",
        ]
        dockerutil.up()
        assert check_mock.mock_calls == [
            call(
    ...
    def test_run(self, run_mock):
        ...
        assert run_mock.mock_calls == [call("COOKIES!")]
    ...
    def test_is_running_up(self, dockerutil_mock):
        ...
        dockerutil_mock.containers.list.return_value = [
            ...
            Container(name="stable_juicebox_1"),
        ]
    ...
    def test_image_list(self, check_mock):
        ...
        for o in output:
            o.pop(1)
        assert output == [[u"master", "30 seconds ago", 4, False, None]]
        ...
        for o in output:
            o.pop(1)
        assert output == [[u"3.22.1", "3 months ago", 2, True, None]]
